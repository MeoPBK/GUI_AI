...
RAG_DATA = {            # model 4 tokenizer in RAG
        ...
        "temperature": 0.3,         #Controlla la casualità dell'output. Valori più alti (es. 1.0) rendono l'output più casuale e creativo, mentre valori più bassi (es. 0.2) lo rendono più deterministico e focalizzato
