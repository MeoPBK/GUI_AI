...
class OllamaPOST:
    ...
    def checkObj(self):
        ...
        print("Role Flag: " + str(self.role_flag))
        print("Answer: " + self.answer)
        print("Role Idx: " + str(self.role_index))
    ...
    def manage_context(self,user_input, assist_input = None):
        ## CONTEXT ON ##
    ...
    def talk_to_ollama(self, user_input):          
        ...
        #response = self.session.post(api_key, headers=HEADERS, json=data, timeout=10)
            ...
            self.manage_context(user_input, cleaned_output_tmp)
...
### INTERNET COMMUNICATION ###
    ...
    def combined_search(self, query, provider=None): #, google_api_key=None, google_cse_id=None, bing_api_key=None):
        try:
            ...
            return f"SYSTEM: Combined search error: {" ".join(e)}"
